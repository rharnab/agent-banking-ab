...
<div class="wrapper wrapper-content" style="margin-bottom: -30px;">
    <div class="row">
        <div class="col-sm-12">
            <a class="btn btn-primary btn-facebook text-white" href="{{ route('commission_setup.account.create') }}">
            ...
            <tbody>
                ...
                @foreach($all_commission as $commission)
                    <tr class="gradeX">
                        ...
                        <td>
	                        <a class="btn btn-primary btn-facebook text-white" href="{{ route('commission_setup.account.edit', $commission->id ) }}">
