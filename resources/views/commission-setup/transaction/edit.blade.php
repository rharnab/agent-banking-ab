...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2> Update Transaction Commission</h2>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Update Transaction  commission</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
    ...
    <div class="row">
        <div class="col-md-5 ">
            <div class="ibox-content">
                <h2 class="font-bold">Update Commission  </h2>
                <div class="row">
                    <div class="col-lg-12">
                        <form class="m-t" id="branch_create_form" role="form" method="POST" action="{{route('commission_setup.transaction.update', $edit_data->id) }}">
                           ...
                           @csrf
                            ...
                            <div class="form-group row hideClass" id="commission_wary_area">
                              ...
                              <div class="form-group row " id="percent_of_amt_for_transaction">
                                <label class="col-lg-4 col-form-label">Percentage Of Amount</label>
                                <div class="col-lg-8">
                                      <input type="text" name="per_of_amount" class="form-control"   placeholder="Percentage Of Amount" value="{{$edit_data->percentage__amount}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" id="fixed_amount">
                                ...
                                <div class="col-lg-8">
                                      <input type="text"  name="commission_amount" class="form-control" placeholder="Commission Amount"  value="{{$edit_data->commission_amount}}">
                                </div>
                            </div>
                              ...
                              <div class="form-group row  " id="start_slab">
                             ...
                             <div class="form-group row " id="end_slab">
