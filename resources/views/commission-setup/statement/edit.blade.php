...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2> Update Statement commission</h2>
        <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-5 ">
            <div class="ibox-content">
                <h2 class="font-bold"> Update Statement Commission </h2>
                <div class="row">
                    <div class="col-lg-12">
                        <form class="m-t" id="branch_create_form" role="form" method="POST" action="{{route('commission_setup.statement.update', $edit_data->id) }}">
