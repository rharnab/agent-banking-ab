...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2> Create Statement commission</h2>
        <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-5 ">
            <div class="ibox-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form class="m-t" id="branch_create_form" role="form" method="POST" action="{{route('commission_setup.statement.store') }}">
                          ...
                          <div class="form-group row" id="fixed_amount">
                                ...
                                <div class="col-lg-8">
                                      <input type="text" required="" name="commission_amount" class="form-control" placeholder="Commission Amount">
                                </div>
                            </div>
                             ...
                             <div class="form-group row hideClass" id="end_slab">
                                ...
                                <div class="col-lg-8">
                                      <input type="text" name="end_slab" class="form-control" placeholder="End Slab">
                                </div>
                            </div> --}}
