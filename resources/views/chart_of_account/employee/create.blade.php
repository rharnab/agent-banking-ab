        ...
        <div class="col-lg-6 offset-lg-3">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form id="account-setup-form" action="{{ route('employee_setup.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="personal_phone" id="personal_phone" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <textarea name="current_address" id="current_address" cols="30" rows="3" class="form-control" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <textarea name="permanent_address" id="permanent_address" cols="30" rows="3" class="form-control" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <textarea name="reference" id="reference" cols="30" rows="3" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="parent_acc">
                            ...
                            <div class="col-lg-8">
                                <div class="custom-file">
                                    <input id="logo" type="file" name="photo" accept="image/x-png,image/gif,image/jpeg" required class="custom-file-input">
                                    <label for="logo" class="custom-file-label">Choose file...</label>
                                </div> 
                            </div>
                        </div>
