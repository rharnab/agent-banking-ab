        ...
        <div class="col-lg-4 offset-lg-3">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Account Setup Form</h5>                   
                </div>
                <div class="ibox-content">
                    <form id="account-setup-form" action="{{ route('account_setup.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-check abc-radio abc-radio-info form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineRadio1" value="no" name="allow_manual_transction">
                                    <label class="form-check-label" for="inlineRadio1"> No </label>
                                </div>
                                <div class="form-check abc-radio form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineRadio2" value="yes" name="allow_manual_transction" checked>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-check abc-radio abc-radio-info form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineRadio3" value="no" name="allow_negetive_transction">
                                    <label class="form-check-label" for="inlineRadio1"> No </label>
                                </div>
                                <div class="form-check abc-radio form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineRadio4" value="yes" name="allow_negetive_transction" checked>
                                    <label class="form-check-label" for="inlineRadio2"> Yes </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-6 col-form-label">Is Default</label>
                            <div class="col-lg-6">
                                <div class="form-check abc-radio abc-radio-info form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineRadio3" value="no" name="is_default">
                                    <label class="form-check-label" for="inlineRadio1"> No </label>
                                </div>
                                <div class="form-check abc-radio form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineRadio4" value="yes" name="is_default" checked>
                                    <label class="form-check-label" for="inlineRadio2"> Yes </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-check abc-radio abc-radio-info form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineRadio3" value="no" name="is_agent_access">
                                    <label class="form-check-label" for="inlineRadio1"> Ho </label>
                                </div>
                                <div class="form-check abc-radio form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineRadio4" value="yes" name="is_agent_access" checked>
                                    <label class="form-check-label" for="inlineRadio2"> Ho/Agent </label>
                                </div>
                            </div>
                        </div>
