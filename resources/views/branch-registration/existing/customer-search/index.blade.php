...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Exists Customer's A/C Open</h2>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Exists Customer's A/C Open</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-5">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form id="customer-search-form" method="POST" action="{{ route('exits.user.account_open.customer_search') }}">
                        @csrf
