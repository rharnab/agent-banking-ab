    ...
    <div class="row">
        ...
        <div class="col-lg-7">
            <div class="ibox collapsed">
                <div style="padding: 20px 14px;  background: #1ab394;  color: #ffffff; font-weight: bold;">
                    <h5>Customer Already Exits in Agent Banking. Please  <a href="{{ route('branch.registration.account_opening_form',[$account_opening_id]) }}">create</a> an account</h5>
                </div>
            </div>
        </div>
