    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Matching Score Create</strong>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-6 offset-md-3">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form id="matching_score_create_form" action="{{  route('matching.score.setup.store')  }}" method="POST">
                        @csrf
                        <p>E-KYC Mathing Socre Setup</p>
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label">Bangla Name Match Percentage</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control  @error('bn_name_percentage') is-invalid @enderror" name="bn_name_percentage" value="{{ old('bn_name_percentage') }}" required > 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control @error('en_name_percentage') is-invalid @enderror" name="en_name_percentage" value="{{ old('en_name_percentage') }}" required > 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text"  class="form-control @error('father_name_percentage') is-invalid @enderror" name="father_name_percentage" value="{{ old('father_name_percentage') }}" required> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text"  class="form-control @error('mother_name_percentage') is-invalid @enderror" name="mother_name_percentage" value="{{ old('mother_name_percentage') }}" required> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control @error('date_of_birth_percentage') is-invalid @enderror" name="date_of_birth_percentage" value="{{ old('date_of_birth_percentage') }}" required> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control @error('address_percentage') is-invalid @enderror" name="address_percentage" value="{{ old('address_percentage') }}" required> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text"  class="form-control @error('face_percentage') is-invalid @enderror" name="face_percentage" value="{{ old('face_percentage') }}" required> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text"  class="form-control @error('blood_group_percentage') is-invalid @enderror" name="blood_group_percentage" value="{{ old('blood_group_percentage') }}" required> 
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label" style="font-weight: bold;">Overall Percentage</label>
                            <div class="col-lg-8">
                                <input type="text"  id="overall_percentage" required  class="form-control @error('overall_percentage') is-invalid @enderror" name="overall_percentage" value="{{ old('overall_percentage') }}" required> 
