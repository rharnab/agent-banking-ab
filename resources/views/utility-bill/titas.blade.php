            ...
            <div class="ibox-content">
                ...
                <form accept="" method="">
                    ...
                    <div class="form-group row">
                         ...
                         <label for="" class="col-sm-2 col-form-label">Bill Type</label>

                        <div class="col-sm-10 ">
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                              <label class="form-check-label" for="inlineRadio1">Non Metered</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2">
                              <label class="form-check-label" for="inlineRadio2">Metered</label>
                            </div>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-10 offset-sm-2">
                     ...
                     <a href="{{route('Utilitybill.titasaction') }}" class="btn btn-primary">Search</a>
                     </div>
                </div>
