            ...
            <div class="ibox-content">
                     ...
                     <form class="m-t" id="branch_create_form" role="form" method="GET" action="{{route('commission.show_account_open')}}">
                          ...
                          <div class="form-group row" id="fixed_amount">
                                ...
                                <div class="col-lg-8">
                                      <input type="text" required="" name="frm_date" id="frm_date" class="form-control" placeholder="Start date">
                                </div>
                            </div>
                              ...
                              <div class="form-group row hideClass " id="start_slab">
                                ...
                                <div class="col-lg-8">
                                      <input type="text" name="to_date"  class="form-control" id="to_date" placeholder="End Date">
                                </div>
                            </div>
