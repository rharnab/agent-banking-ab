...
@section('title', 'Statement commission report')
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-9">
        <h2>Statement commisssion report</h2>
        <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="ibox ">
            ...
            <div class="ibox-content">
                     ...
                     <form class="m-t" id="branch_create_form" role="form" method="GET" action="{{route('commission.statement_summary_report')}}">
