...
@section('title', 'Bill commission report')
    ...
    <div class="row">
        ...
        <div class="ibox ">
            ...
            <div class="ibox-content">
                     ...
                     <form class="m-t" id="branch_create_form" role="form" method="GET" action="{{route('commission.bill_summary_report')}}">
