...
@section('title', 'transaction commission report')
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-9">
        <h2>Transaction commisssion report</h2>
        <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="ibox ">
            ...
            <div class="ibox-content">
                     ...
                     <form class="m-t" id="branch_create_form" role="form" method="GET" action="{{route('commission.transaction_summary_report')}}">
                           ...
                           @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <select  id="flag_type" class="select2 form-control" name="commission_type" >
                                       <option value="">All</option>
