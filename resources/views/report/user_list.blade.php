    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>User List Report</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center ">
                                        @if($user->is_active == 1)
                                            <span style="font-size: 16px; color:green;" onclick="deactiveUser({{ $user->id }})">Active</span>
                                            <form id="deactive-user-{{ $user->id }}" action="{{ route('parameter.user.deactive',$user->id) }}" method="GET" style="display: none;"></form>
                                        @else
                                            <span style="font-size: 16px; color:red;" onclick="activeUser({{ $user->id }})"> Deactive </span>
