...
@section('title', 'Transfer Transaction')
...
<div class="wrapper wrapper-content animated fadeInRight">
    <form class="m-t" id="branch_create_form" role="form" method="POST" action="{{ route('report.agent_user.transasction.transfer.search') }}">
        @csrf
    <div class="row">
        <div class="col-md-6">
            <div class="ibox-content">
                <h2 class="font-bold">Transfer Transaction</h2>
				<hr>
                <div class="row">
                    <div class="col-lg-12">   
