...
<div class="wrapper wrapper-content animated fadeInRight">
    <form class="m-t" id="branch_create_form" role="form" method="POST" action="{{ route('agent.user.password_reset.reset') }}">
        @csrf
    <div class="row">
        <div class="col-md-4">
            <div class="ibox-content">
                <h2 class="font-bold">Reset User Password</h2>
                <hr>
                <div class="row">
                    <div class="col-lg-12">                        
                            ...
                            <div class="col-lg-12">
                                <select class="select2 form-control @error('agent_user_id') is-invalid @enderror" name="agent_user_id" required>
                                   ...
                                   @foreach($agent_users as $agent_user)
                                        <option value="{{ $agent_user->user_id }}">{{ $agent_user->name }}</option>
                                   @endforeach
                                </select>
                            </div>
                        </div>               
