...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-md-6">
            ...
            <div class="action-button mt-3">
                ...
                @elseif($request_info->status == 3)
                    ...
                    <a href="{{ route('outside.customer.show_edit_page') }}" class="btn btn-primary">Edit Request</a> 
                @elseif($request_info->status == 1)
                    <button type="button" disabled class="btn btn-w-m btn-danger">Account Opening Request Pending</button>
                @endif
    ...
    <div class="row">
        ...
        <!-- Image Section Start -->
        <div class="col-lg-4">
            @if($ec_info['ec_photo_src'] != '')
                <div class="ibox">
                    <div class="ibox-content">
                        <h3 style="font-weight:bold; color:#000">EC Face Image</h3>
                        <hr>
                        <img class="img img-fluid img-responsive"  id="ec_face_image" src="{{ $ec_info['ec_photo_src'] }}" alt="">
                    </div>
                </div>
            @endif
                ...
                <div class="col-md-6">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <input type="hidden" id="ocr_and_ec_text_comparison_score" value="{{ $ec_info['average_text_matching_score'] }}">
                            <div class="text-center">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><span id="ec_bangla_name">{{ $ec_info['ec_bn_name'] }}</span></td>                                
                                <td id="bangla_name_percentage">{{ $ec_info['bn_name_percentage'] }}</td>
                            </tr>
                            <tr>
                                <td>English Name</td>
                                <td><span id="ocr_english_name">{{ $request_info->en_name }}</span></td>
                                <td><span id="ec_english_name">{{ $ec_info['ec_en_name'] }}</span></td>                                
                                <td id="english_name_percentage">{{ $ec_info['en_name_percentage'] }}</td>
                            </tr>
                            <tr>
                                <td>Father Name</td>
                                <td><span id="ocr_father_name">{{ $request_info->father_name }}</span></td>
                                <td><span id="ec_father_name">{{ $ec_info['ec_father_name'] }}</span></td>                                
                                <td  id="father_name_percentage">{{ $ec_info['father_name_percentage'] }}</td>
                            </tr>
                            <tr>
                                <td>Mother Name</td>
                                <td><span id="ocr_mother_name">{{ $request_info->mother_name }}</span></td>
                                <td><span id="ec_mother_name">{{ $ec_info['ec_mother_name'] }}</span></td>                                
                                <td  id="mother_name_percentage">{{ $ec_info['mother_name_percentage'] }}</td>
                            </tr>
                            <tr>
                                <td>Date Of Birth</td>
                                <td><span id="ocr_date_of_birth">{{ $request_info->date_of_birth }}</span></td>
                                <td><span id="ec_date_of_birth">{{ $ec_info['ec_date_of_birth'] }}</span></td>                                
                                <td  id="date_of_birth_percentage">{{ $ec_info['date_of_birth_percentage'] }}</td>
                            </tr>
                            <tr>
                                <td>Address</td>
                                <td><span id="ocr_address">{{ $request_info->present_address }}</span></td>
                                <td><span id="ec_address">{{ $ec_info['ec_permanentAddress'] }}</span></td>                                
                                <td id="address_percentage">{{ $ec_info['address_percentage'] }}</td>
                            </tr>
