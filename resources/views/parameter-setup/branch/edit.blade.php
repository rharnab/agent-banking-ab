    ...
    <div class="row">
        <div class="col-md-4 offset-md-4">
            <div class="ibox-content">
                <h2 class="font-bold">Edit Branch</h2>
                <div class="row">
                    <div class="col-lg-12">
                        <form class="m-t" id="role_create_form" role="form" method="POST" action="{{ route('parameter.branch.update',$branch->id) }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="br_code" value="{{ $branch->br_code }}" class="form-control" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="routing_number" class="form-control" value="{{ $branch->routing_number }}"  required="">
                            </div>                            
                            <button type="submit" class="btn btn-primary block full-width m-b">Update Branch</button>
                        </form>
                    </div>
                </div>
            </div>
