...
<div class="wrapper wrapper-content animated fadeInRight">
    <form class="m-t" id="branch_create_form" role="form" method="POST" action="{{ route('parameter.agent.store') }}">
        @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="ibox-content">
                <h2 class="font-bold">Crete New Agent</h2>
                <div class="row">
                    <div class="col-lg-6">                        
                            ...
                            <div class="form-group">
                                <label for="">Agent Id (Login)</label>
                    ...
                    <div class="col-lg-6">                                    
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12">
                                <select class="select2 form-control @error('branch_id') is-invalid @enderror" name="branch_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" cols="3" rows="2" class="form-control" required></textarea>
                        </div>                                
