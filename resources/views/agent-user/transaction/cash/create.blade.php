...
<div class="wrapper wrapper-content animated fadeInRight">
    <form class="m-t" id="branch_create_form" role="form" method="POST" action="{{ route('agent_user.transaction.cash.store') }}">
        @csrf
    <div class="row">
        <div class="col-md-6">
            <div class="ibox-content">
                <h2 class="font-bold">Create New Cash Transaction</h2>
                <div class="row">
                    <div class="col-lg-12">   
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12">
                                <select class="select2 form-control @error('account_type') is-invalid @enderror js-example-basic-single" name="account_type" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12">
                                <select class="select2 form-control @error('transaction_type') is-invalid @enderror" name="transaction_type" id="transaction_type" required>
                                    ...
                                    <option value="3">Cash - Withdraw</option>
                                </select>
                            </div>
                        </div>
