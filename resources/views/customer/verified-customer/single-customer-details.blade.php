...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row m-b-lg m-t-lg">
        ...
        <div class="col-md-6">
            <div class="button_div" style="text-align: right!important">
                <h4 class="no-margins"><small>Verified On </small>{{ date('jS F,Y h:i a', strtotime($request_info->created_at)) }}</h4>               
            </div>           
        </div>
                ...
                <div class="col-md-4">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <hr>
                            <h2> <span id="ocr_and_ec_percentage_text">{{ $request_info->text_maching_score }}</span> / 100</h2>
                            <input type="hidden" id="ocr_and_ec_text_comparison_score" value="{{ $request_info->text_maching_score }}">
                            <div class="text-center">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><span id="ec_bangla_name">{{ $request_info->name }}</span></td>                                
