...
namespace App\Http\Controllers\Report\HeadOffice;
...
class AccountListController extends Controller
{
    public function index(){
        $agents = DB::table('agents')->select('id', 'name')->get();
        ...
        return view('report.head-office.account-list.index', $data);
    }
    ...
    public function search(Request $request){
        ...
        if($request->input('agent_id') == "all"){
            ...
            $agent_sql = " and agent_id=$agent_id   ";
        }
        ...
        where date(aca.created_at) between '$starting_date' and '$ending_date' $agent_sql $account_sql $product_sql";
        ...
        return view('report.head-office.account-list.response', $data);
